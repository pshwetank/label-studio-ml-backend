...
class YOLOBackend(LabelStudioMLBase):
    """Object detector based on https://github.com/ultralytics/yolov5"""

    def __init__(self, config_file, checkpoint_file, image_dir=None, labels_file=None, score_threshold=0.3, device='cpu', **kwargs):
        """
        Load Yolov5 model from config and checkpoint into memory.

        Optionally set mappings from COCO classes to target labels
        :param config_file: Absolute path to Yolov5 config file (e.g. /home/user/mmdetection/configs/faster_rcnn/faster_rcnn_r50_fpn_1x.py)
        :param checkpoint_file: Absolute path Yolov5 checkpoint file (e.g. /home/user/mmdetection/checkpoints/faster_rcnn_r50_fpn_1x_20181010-3d1b3351.pth)
